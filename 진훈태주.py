...
def Slowloris_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("Slowloris Attack 설명문")
    nw.geometry("400x250+450+450")

    slowloris_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="Slowloris Attack")
    slowloris2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
def Land_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("Land Attack 설명문")
    nw.geometry("400x250+450+450")
    Land_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="Land Attack")
    Land2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
def TCP_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("TCP Flood 설명문")
    nw.geometry("400x250+450+450")
    TCP_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="TCP Flood")
    TCP2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
def UDP_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("UDP Flood 설명문")
    nw.geometry("400x250+450+450")
    UDP_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="UDP Flood")
    UDP2_label = Label(nw, justify=LEFT, height=50, width=70, text="Udp Flooding Attack\n"
                                                                    "  정의\n"
...
def ICMP_exbutton_win(self):
    ...
    nw.geometry("400x250+450+450")
    ICMP_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="ICMP Flood")
    ICMP2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
def RUDY_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("RUDY Attack 설명문")
    nw.geometry("400x250+450+450")
    RUDY_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="RUDY Attack")
    RUDY2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
def Teardrop_exbutton_win(self):
    nw = tkinter.Tk()
    nw.title("Teardrop Attack 설명문")
    nw.geometry("400x250+450+450")
    Teardrop_label = Label(nw, justify=CENTER, height=1, width=15, font=("맑은 고딕", 15), text="Teardrop Attack")
    Teardrop2_label = Label(nw, justify=LEFT, height=50, width=70, text="  정의\n"
...
class GUIMODE():
    ...
    def packet_temp(self):
        packet_result = sniff(iface="VMware Network Adapter VMnet1", filter='ip', prn=self.showPacket, count=500)
        wrpcap("C:\\Users\\dbwng\\Desktop\\packet.pcap", packet_result)
